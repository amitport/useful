...
<p>
    ...
    If you attempted to sign-in you need to first <a href="${this.origin}">sign-up to ${this.siteName}</a>.<br>
...
We received an attempt to recover an account associated with you email but did not find such an account.
If you attempted to sign-in you need to first sign-up to ${this.siteName} using the following link: ${this.origin}.
Otherwise, you can safely ignore this email.
