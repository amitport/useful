...
<p>
    ...
    If you have forgotten your password, you can recover it using the following <a href="${this.homeUrl}">link</a>.
...
If you have forgotten your password, you can recover it using the following link: ${this.homeUrl}.
Otherwise, you can safely ignore this email.
